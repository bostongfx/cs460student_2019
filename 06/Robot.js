Robot = function(x, y, z) {
  ...
  this.left_upper_leg.position.y = -40;
  this.torso.add(this.left_upper_leg);

  this.left_lower_leg = new THREE.Bone();
  this.left_lower_leg.postion.x = -10;
  this.left_lower_leg.position.y = -50;
  this.left_upper_leg.add(this.left_lower_leg);

  this.left_foot = new THREE.Bone();
  this.left_foot.postion.x = -10;
  this.left_foot.position.y = -55;
  ...
  this.right_upper_leg.position.y = -40;
  this.torso.add(this.right_upper_leg);

  this.right_lower_leg = new THREE.Bone();
  this.right_lower_leg.postion.x = 10;
  this.right_lower_leg.position.y = -50;
  this.right_upper_leg.add(this.right_lower_leg);

  this.right_foot = new THREE.Bone();
  this.right_foot.postion.x = 10;
  this.right_foot.position.y = -55;
