Robot = function(x, y, z) {
  ...
  this.right_upperleg.position.x = -30;
  this.right_upperleg.position.y = -10;

  this.right_lowerleg = bones[ 2 ];
  this.right_lowerleg.position.x = 0;
  this.right_lowerleg.position.y = -15;

  this.right_leg = bones[ 3 ];
  this.right_leg.position.x = -10;
  this.right_leg.position.y = 0;
  ...
  this.left_upperleg.position.x = 30;
  this.left_upperleg.position.y = -10;

  this.left_lowerleg = bones[ 2 ];
  this.left_lowerleg.position.x = 0;
  this.left_lowerleg.position.y = -15;

  this.left_leg = bones[ 3 ];
  this.left_leg.position.x = 10;
  this.left_leg.position.y = 0;
