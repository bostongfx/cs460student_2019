...
Original file is located at
    https://colab.research.google.com/drive/1WNRa85-z2U6ps7QehO4XrBh6gyyrW7vt
"""

import numpy as np
import base64

with open("armadillo.ply", 'rb') as f:
    lines = f.readlines()
...
result = open("armadillo.gltf", "w")

print( str(gltf).replace("'",'"'), file = result)