Robot = function(x, y, z) {
    ...
    var fromhelper = HELPER.cylinderSkeletonMesh(3, 5, '#2253f3')
  ...
  Robot.prototype.onAnimate = function() {
    ...
    if (this.movement == 'raise left arm') {
      ...
      if (typeof this.dancer === 'undefined') {
        ...
        var T = -Math.PI/2; // 45 degrees
        this.right_upperleg.quaternion.slerp( new THREE.Quaternion( Math.sin( T / 2 ), 0, 0, Math.cos( T / 2 ) ), 0.05 );
