...
Robot.prototype.onAnimate = function() {
  ...
  else if (this.movement == 'ResetR') { //reset leg mid and exchange leg movement
  ...
  else if (this.movement == 'walk2') {	//right leg forward left leg backward
	  if (this.right_upperleg.quaternion.w < 0.93) {
		  this.moved = false;
		  this.movement = 'ResetR';
		} else {
		//reset other leg
  ...
  else if (this.movement == 'walk') { //left leg forward right leg backward
